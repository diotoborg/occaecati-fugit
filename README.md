...
[![npm](https://img.shields.io/npm/v/@diotoborg/occaecati-fugit.svg)](https://www.npmjs.com/package/@diotoborg/occaecati-fugit)
[![npm](https://img.shields.io/npm/dm/@diotoborg/occaecati-fugit.svg?style=flat)](https://www.npmjs.com/package/@diotoborg/occaecati-fugit)
[![Coverage Status](https://coveralls.io/repos/github/Smoren/@diotoborg/occaecati-fugit/badge.svg?branch=master&rand=123)](https://coveralls.io/github/Smoren/@diotoborg/occaecati-fugit?branch=master)
![Build and test](https://github.com/diotoborg/occaecati-fugit/actions/workflows/test_master.yml/badge.svg)
[![Minified Size](https://badgen.net/bundlephobia/minzip/@diotoborg/occaecati-fugit)](https://bundlephobia.com/result?p=@diotoborg/occaecati-fugit)
...
```typescript
import { multi } from '@diotoborg/occaecati-fugit';
...
```typescript
import { Stream, AsyncStream } from '@diotoborg/occaecati-fugit';
...
```typescript
import { single } from '@diotoborg/occaecati-fugit';
...
```bash
npm i @diotoborg/occaecati-fugit
```
...
```typescript
import { infinite } from '@diotoborg/occaecati-fugit';
...
```typescript
import { math } from '@diotoborg/occaecati-fugit';
...
```typescript
import { reduce } from '@diotoborg/occaecati-fugit';
...
```typescript
import { set } from '@diotoborg/occaecati-fugit';
...
```typescript
import { summary } from "@diotoborg/occaecati-fugit";
...
```typescript
import { transform } from "@diotoborg/occaecati-fugit";
...
```typescript
import { Stream } from "@diotoborg/occaecati-fugit";
